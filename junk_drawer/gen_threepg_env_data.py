...
gen_file = "threepg_env_data.py"
csv_file = "Parameters/default_environment_data.csv"
...
def create_header():
    ...
    description = "Description: " + "Holds the Environment class, which will be used to manipulate common parameters\n\tfor the environment used in a simulation.\n"
...
def generate_python_file(csv_file_path, output_file_path):
    ...
    with open(output_file_path, 'w') as output_file:
        ...
        output_file.write("\nfrom parse_tree_input import csv_file_to_list\n\n")
        output_file.write("class Environment:\n")
        output_file.write("    def __init__(self, " + parameter_init + "):\n")
        output_file.write("        \"\"\"\n")
        output_file.write("        Initializes the Environment class with the provided attributes.\n")
        output_file.write("        \"\"\"\n")
