...
from junk_drawer.threepg_species_data import SpeciesData, get_tree_names, parse_species_data
...
def plot_trees(foliage_file, threepg=True, plot=False, num_trees=50, min_distance=0.05):
    """
    Takes in a tree_chart csv, outputs a series of random tree placements to a CSV (name,x,y)
    Can use 3pg, can create a scatter plot visualization
    Used for initial placement of trees to apply 3PG
...
# Example usage:
plot_trees('test_data/Bend_Oregon_foliage.csv', plot=True)